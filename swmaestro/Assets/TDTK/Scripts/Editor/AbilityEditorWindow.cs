...
namespace TDTK {
	...
	public class AbilityEditorWindow : EditorWindow {
		...
		Vector2 DrawAbilityConfigurator(float startX, float startY, Ability ability){
			...
			ability.disableInAbilityManager=EditorGUI.Toggle(new Rect(startX+390, startY, 185, height), ability.disableInAbilityManager);
			...
			return new Vector2(contWidth, startY);
		}
