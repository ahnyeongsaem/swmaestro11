...
namespace TDTK {
	...
	public class ShootObjectEditor : Editor {
		...
		public override void OnInspectorGUI(){
			...
			cont=new GUIContent("Kill Effect:", "The gameObject (as visual effect) to be spawn at hit point when the shootObject destroy it's target");
			instance.destroyEffect=(GameObject)EditorGUILayout.ObjectField(cont, instance.destroyEffect, typeof(GameObject), true);
